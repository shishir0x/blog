...
export const fontConfig = {
  enable: true, // Enable custom font feature
  preload: true, // Preload font files to improve performance
  selected: ["system"], // Currently selected fonts, supports multiple font combinations
  fonts: {
    // System font
    system: {
      id: "system",
      name: "System Font",
      src: "", // System font does not require src
      family:
